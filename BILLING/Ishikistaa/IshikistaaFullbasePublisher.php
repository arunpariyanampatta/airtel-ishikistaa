...
$sql = "SELECT ID,MSISDN,TOTAL_AMOUNT_CHARGED, NEXT_AMOUNT_CHARGE FROM tbl_subscribers WHERE ID > '".$id."' AND SUB_CHARGING_STATUS = '1' AND TOTAL_AMOUNT_CHARGED = 0 AND QUEUE_STATUS = '1' AND RETRY_STATUS = '1' LIMIT 1000" ;
$conn  = connect_db();
...
while($row = mysqli_fetch_array($result)){
 ...
 if(empty($broadcast)){
     ...
     for($j=0;$j<sizeof($broadcast);$j++){
         ...
         $str = array("msisdn"=>$mobile,"amount"=>99,"charging_type"=>"fullbase");
