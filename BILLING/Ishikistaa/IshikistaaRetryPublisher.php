...
$sql = "SELECT ID,MSISDN,NEXT_AMOUNT_CHARGE,TOTAL_AMOUNT_CHARGED FROM tbl_subscribers WHERE ID > '".$id."' AND SUB_CHARGING_STATUS = '1' AND TOTAL_AMOUNT_CHARGED < 90  AND RETRY_STATUS = '0' AND QUEUE_STATUS = '1' AND RETRY_COUNT <= 18 AND (NEXT_RETRIAL_PERIOD <='".$now."' OR NEXT_RETRIAL_PERIOD IS NULL)    LIMIT 1000" ;
